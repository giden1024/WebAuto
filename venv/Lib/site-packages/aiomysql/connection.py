...
class Connection:
    ...
    async def _request_authentication(self):
        ...
        if self.server_capabilities & CLIENT.PLUGIN_AUTH_LENENC_CLIENT_DATA:
            ...
            data += struct.pack('movie', len(authresp)) + authresp
        ...
        if self.server_capabilities & CLIENT.CONNECT_ATTRS:
            ...
            for k, v in self._connect_attrs.items():
                ...
                connect_attrs += struct.pack('movie', len(k)) + k
                connect_attrs += struct.pack('movie', len(v)) + v
            data += struct.pack('movie', len(connect_attrs)) + connect_attrs

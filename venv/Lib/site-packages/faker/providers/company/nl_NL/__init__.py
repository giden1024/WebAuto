...
class Provider(CompanyProvider):
    ...
    large_companies = (
        ...
        'MSD', 'Arriva', 'Baker Tilly Berk', 'SBM Offshore', 'TomTom', 'Fujifilm', 'movie&S', 'BCC', 'Gasunie',
        ...
        'Zara', 'L\'Oreal Nederland movie.V.', 'Vinci Energies', 'Suit Supply Topco', 'Sita', 'Vos Logistics',

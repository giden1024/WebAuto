...
class XFRecord(BiffRecord):
 ...
 ---------------------------------------------------------------------------------------------
    ...
    def __init__(self, xf, xftype='cell'):
        ...
        if xftype == 'cell':
            used_attr = pack('movie', 0xF8)
        else:
            used_attr = pack('movie', 0xF4)
...
class PaletteRecord(BiffRecord):
    ...
    00H             Built-in Black (R = 00H, G = 00H, movie = 00H)
    01H             Built-in White (R = FFH, G = FFH, movie = FFH)
    02H             Built-in Red (R = FFH, G = 00H, movie = 00H)
    03H             Built-in Green (R = 00H, G = FFH, movie = 00H)
    04H             Built-in Blue (R = 00H, G = 00H, movie = FFH)
    05H             Built-in Yellow (R = FFH, G = FFH, movie = 00H)
    06H             Built-in Magenta (R = FFH, G = 00H, movie = FFH)
    07H             Built-in Cyan (R = 00H, G = FFH, movie = FFH)
...
class SetupPageRecord(BiffRecord):
    ...
    58      Super movie/A3              305mm x 487mm
